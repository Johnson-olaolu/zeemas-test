    ...
    return (
        <div className=' h-screen overflow-hidden'>
            <section className="flex">
                ...
                <div className=" flex-grow overflow-auto bg-gray-100 h-screen px-10 py-8">
                    <div className=" text-right mb-9">
                        <FontAwesomeIcon icon={faEllipsisH} className=' text-Sidebar2MenuText' />
                    </div>
                    <div className="flex justify-between items-center mb-3">
                        <span className=" font-bold font-Futura text-titleBlue">Project stats</span>
                        <div className=" rounded-lg bg-white flex justify-between px-3 items-center h-10  space-x-8 cursor-pointer">
                            <span className=' text-Sidebar2Text text-sm'>All time</span>
                    ...
                    <div  className=" grid grid-cols-2 gap-4 mb-24">
                        <div className="  grid grid-cols-2 gap-4">
                            <div className="col-span-1  bg-white rounded-lg px-4 pb-4">
                                <div className="flex items-center h-12 border-b border-gray-100 space-x-2 mb-7">
                                    <span className=' text-sm text-Sidebar2MenuText'>Average PR Size</span>
                                    <AlertCircle className=' w-3 text-Sidebar2MenuText' />
                                </div>
                                <div className=" grid grid-cols-2 mb-7">
                                    <div className=" space-y-1">
                                        <p className="space-x-1">
                                            <span className=" font-bold font-Futura">968</span>
                                            <span className=" text-xs text-Sidebar2MenuText">lines</span>
                                        </p>
                                        <p className="text-sm text-Sidebar2MenuText">Line Change</p>
                                    </div>
                                    <div className=" space-y-1">
                                        <p className="space-x-1">
                                            <span className=" font-bold font-Futura ">240</span>
                                            <span className=" text-xs text-Sidebar2MenuText">kb</span>
                                        </p>
                                        <p className="text-sm text-Sidebar2MenuText">Size</p>
                                    </div>
                                </div>
                            ...
                            <div className="col-span-1 bg-white rounded-lg px-4 pb-4">
                                <div className="flex items-center h-12 border-b border-gray-100 space-x-2 mb-7">
                                    <span className=' text-sm text-Sidebar2MenuText'>Average Ticket Duration</span>
                                    <AlertCircle className=' w-3 text-Sidebar2MenuText' />
                                </div>
                                <div className="mb-7">
                                    <div className=" space-y-1">
                                        <p className="space-x-1">
                                            <span className=" font-bold font-Futura">36</span>
                                            <span className=" text-xs text-Sidebar2MenuText">hours</span>
                                        </p>
                                        <p className="text-sm text-Sidebar2MenuText">Hours worked</p>
                                    </div>
                                </div>
                            ...
                            <div className=" col-span-2 bg-white rounded-lg px-4 pb-4">
                                <div className="flex items-center h-12 border-b border-gray-100 space-x-2 mb-5">
                                    <span className=' text-sm text-Sidebar2MenuText'>Cycle Time</span>
                                    <AlertCircle className=' w-3 text-Sidebar2MenuText' />
                                </div>
                                <div className=" flex">
                                    ...
                                    <div className=" grid grid-cols-2">
                                        <div className=" relative mb-3">
                                            ...
                                            <div className=" absolute top-1/2 left-1/2  -ml-2 -translate-x-1/2 -translate-y-1/2 text-center">
                                                <span className='  font-bold'>17 hrs</span>
                                        ...
                                        <div className="py-3 pl-10">
                                            <ul className=" h-full flex flex-col justify-between ">
                                                <li className="flex ">
                                                    ...
                                                    <span className=" text-sm font-medium mr-2">4hrs</span>
                                                    <span className=" text-sm text-Sidebar2MenuText">Coding</span>
                                                </li>
                                                <li className="flex ">
                                                    <div className=" h-4 w-4 rounded-full mr-3" style={{ backgroundColor: "#56B0E3" }}></div>
                                                    <span className=" text-sm font-medium mr-2">8hrs</span>
                                                    <span className=" text-sm text-Sidebar2MenuText">Code Review</span>
                                                </li>
                                                <li className="flex ">
                                                    <div className=" h-4 w-4 rounded-full mr-3" style={{ backgroundColor: "#0F283B" }}></div>
                                                    <span className=" text-sm font-medium mr-2">1hrs</span>
                                                    <span className=" text-sm text-Sidebar2MenuText">QA Review</span>
                                                </li>
                                                <li className="flex ">
                                                    <div className=" h-4 w-4 rounded-full mr-3" style={{ backgroundColor: "#DF6340" }}></div>
                                                    <span className=" text-sm font-medium mr-2">3hrs</span>
                                                    <span className=" text-sm text-Sidebar2MenuText">Idle Time</span>
                                                </li>
                                                <li className="flex ">
                                                    <div className=" h-4 w-4 rounded-full mr-3" style={{ backgroundColor: "#7E6BF1" }}></div>
                                                    <span className=" text-sm font-medium mr-2">1hrs</span>
                                                    <span className=" text-sm text-Sidebar2MenuText">Deployment</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div className=" grid gap-4">
                            <div className="col-span-1  bg-white rounded-lg px-4 pb-4">
                                <div className="flex items-center h-12 border-b border-gray-100 space-x-2 mb-7">
                                    <span className=' text-sm text-Sidebar2MenuText'>Work Breakdown</span>
                                    <AlertCircle className=' w-3 text-Sidebar2MenuText' />
                                </div>
                                <div className="flex  mb-7 space-x-6">
                                    ...
                                    <p className="space-x-1">
                                        <span className=" font-bold font-Futura">54</span>
                                        <span className=" text-xs text-Sidebar2MenuText">tickets</span>
                                    </p>
                                    <p className="space-x-1">
                                        <span className=" font-bold font-Futura">4</span>
                                        <span className=" text-xs text-Sidebar2MenuText">total weeks worked</span>
                                    </p>
                                </div>
                                ...
                                <div className=" grid grid-cols-2 gap-y-4">
                                    <div className="flex ">
                                        ...
                                        <span className=" text-sm text-Sidebar2MenuText">New work</span>
                                    </div>
                                    <div className="flex ">
                                        <div className=" h-4 w-4 rounded-full mr-3" style={{ backgroundColor: "#56B0E3" }}></div>
                                        <span className=" text-sm font-medium mr-2">15%</span>
                                        <span className=" text-sm text-Sidebar2MenuText">Rework</span>
                                    </div>
                                    <div className="flex ">
                                        <div className=" h-4 w-4 rounded-full mr-3" style={{ backgroundColor: "#0F283B" }}></div>
                                        <span className=" text-sm font-medium mr-2">40%</span>
                                        <span className=" text-sm text-Sidebar2MenuText">Refactor</span>
                                    </div>
                                    <div className="flex ">
                                        <div className=" h-4 w-4 rounded-full mr-3" style={{ backgroundColor: "#DF6340" }}></div>
                                        <span className=" text-sm font-medium mr-2">20%</span>
                                        <span className=" text-sm text-Sidebar2MenuText">Bugs</span>
                                    </div>
                                </div>
                            </div>
                            <div className="col-span-1  bg-white rounded-lg px-4 pb-4">
                                <div className="flex items-center h-12 border-b border-gray-100  mb-7 justify-between">
                                    <div className="space-x-2 flex items-center">
                                        <span className=' text-sm text-Sidebar2MenuText'>Idle Time Breakdown</span>
                                        <AlertCircle className=' w-3 text-Sidebar2MenuText' />
                                    </div>
